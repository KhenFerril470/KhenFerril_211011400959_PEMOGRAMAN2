...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query untuk menyimpan data ke dalam tabel tbladmin
    ...
    if ($koneksi->query($query) === TRUE) {
        ...
        echo "<script>window.location.href = 'adminroti.php';</script>";
        exit();
    } else {
...
<body>
    <div class="container">
        ...
        <div class="form-container">
            <div class="text-beside-image">DAFTAR ADMIN ROTI LEZAT</div>
            ...
            <div class="form-group">
                <a href="login.php" style="text-decoration: none; color: #333;">Kembali ke halaman Login user pelanggan</a>
            </div>
        </div>
    </div>
</body>
